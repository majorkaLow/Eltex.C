...
Каждый выбирает способ удобнее для самого себя, мы разберем самый простой и понятный для начинающих разработчиков - использование оболочки **GitLab**.
 ...
 1. **Авторизуйтесь** под своим логином и паролем в системе GitLab
 2. Откройте список **своих репозиториев** Projects 
 ![image](img/createBranch/1.png)
 3. **При нажатии** на кнопку [New Project](https://repos.21-school.ru/projects/new) вам будет предложено создать **пустой проект** Create Blank Project
...
Самым простым способом создания веток для новых разработчиков является **визуальная оболочка**, именно ее мы и разберем сегодня.
 ...
 3. Наводимся на вкладку "**Repository**", выбираем в выпавшем списке Branches
 ![image](img/createBranch/1.png)
 4. В новой вкладке у нас появляется доступ к кнопке New Branch, которая и позволит создать новую ветку.
 ![image](img/createBranch/2.png)
...
Самым простым способом создания веток для новых разработчиков является  **визуальная оболочка**, именно ее мы и разберем сегодня.
 ...
 1. **Авторизуйтесь** под своим логином и паролем в системе GitLab.
 2. Перейдите в необходимый репозиторий на GitLab.
